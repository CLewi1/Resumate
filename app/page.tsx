                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        ...
                        <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
                            ResuM8 scans job descriptions and intelligently
                            rewrites your resume keywords to match ATS
                            algorithms in real-time. Get interviewed, not
                            filtered.
                        </p>
                        ...
                        <div className="pt-8 flex items-center gap-4 text-sm text-slate-500">
                            <div className="flex -space-x-2">
                                {[1, 2, 3, 4].map((i) => (
                                    <div
                                        key={i}
                                        className={`w-8 h-8 rounded-full border-2 border-slate-950 bg-slate-800 flex items-center justify-center text-[10px] text-white`}
                                    >
                                        U{i}
                                    </div>
                                ))}
            ...
            <footer className="border-t border-white/5 bg-slate-950 py-12">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-sm font-semibold text-slate-500 uppercase tracking-widest mb-8">
                        Optimized for top ATS platforms
                    </p>
