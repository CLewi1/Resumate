            ...
            <div className="relative bg-white border border-slate-200 w-full max-w-md rounded-2xl p-8 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-slate-600 text-sm">
                        Sign in to sync your resumes and track job applications.
                    </p>
                </div>
                ...
                <div className="space-y-3 relative z-10">
                    <button
                        ...
                        className="w-full bg-[#24292F] hover:bg-[#1b1f23] border border-[#24292F] text-white p-3.5 rounded-xl flex items-center justify-center gap-3 transition-all font-medium group"
                    >
                        <Github
                            size={20}
                    ...
                    <button
                        ...
                        className="w-full bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 p-3.5 rounded-xl flex items-center justify-center gap-3 font-semibold transition-colors shadow-xs"
                    >
                        <div className="w-5 h-5 rounded-full bg-linear-to-tr from-blue-500 to-red-500 flex items-center justify-center text-[10px] text-white font-bold">
                            G
                        </div>
